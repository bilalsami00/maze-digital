...
export default function Login() {
  ...
  height={62} 
/>
        <p className="text-[40px] sm:text-[40px] font-bold text-black mt-4 text-center">
          Elite Ghost Writing.
        </p>
  ...
  <form className="mt-2" onSubmit={handleLogin}>
    ...
    <input
      type="email"
      placeholder="Email"
      className="w-full border border-gray-300 p-3 rounded-[20px] focus:outline-none focus:ring-2 focus:ring-blue-500"
      required
    />
